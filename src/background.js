...
// browser.idle.onStateChanged.addListener(fetchDate)
browser.tabs.onCreated.addListener(fetchDate)
browser.runtime.onInstalled.addListener(fetchDate)
browser.runtime.onStartup.addListener(fetchDate)
